...
In [this previous guide](https://pencer.io/guides/guides-kali-install/) I went through the steps of importing the VirtualBox specific pre-built image of Kali 2020.2a. Now we will walk through a first boot of that virtual machine, and the things you will probably want to do before using it in earnest.
